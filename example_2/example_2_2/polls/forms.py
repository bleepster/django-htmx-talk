...
class PollsUserCreationForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["username"].widget.attrs["hx-trigger"] = "focusout"
        self.fields["username"].widget.attrs["hx-get"] = reverse('polls:check_username')
        self.fields["username"].widget.attrs["hx-target"] = "#username_errors"
